...
func TestGetTweetWithVideo(t *testing.T) {
	expectedTweet := twitterscraper.Tweet{
		...
		Name:           "X",
		PermanentURL:   "https://x.com/X/status/1697304622749086011",
		Photos:         nil,
...
func TestGetTweetWithMultiplePhotos(t *testing.T) {
	expectedTweet := twitterscraper.Tweet{
		...
		Name:           "Support",
		PermanentURL:   "https://x.com/Support/status/1577677328968204291",
...
func TestGetTweetWithGIF(t *testing.T) {
	expectedTweet := twitterscraper.Tweet{
		...
		Name:         "Support",
		PermanentURL: "https://x.com/Support/status/1517535384833605632",
...
func TestGetTweetWithPhotoAndGIF(t *testing.T) {
	expectedTweet := twitterscraper.Tweet{
		...
		Name:         "Spaces",
		PermanentURL: "https://x.com/XSpaces/status/1583186305722507265",
...
func TestRetweet(t *testing.T) {
	sample := &twitterscraper.Tweet{
		...
		IsSelfThread:   false,
		Name:           "Premium",
		PermanentURL:   "https://x.com/premium/status/1758837061786779942",
